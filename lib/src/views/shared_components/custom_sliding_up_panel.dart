...
enum CustomSlideDirection {
  UP,
  DOWN,
}

enum CustomPanelState { OPEN, CLOSED }
...
class CustomSlidingUpPanel extends StatefulWidget {
  ...
  /// down on the panel.
  final CustomSlideDirection slideDirection;
  ...
  final CustomPanelState defaultPanelState;
  ...
  CustomSlidingUpPanel(
      {Key? key,
        ...
        this.slideDirection = CustomSlideDirection.UP,
        this.defaultPanelState = CustomPanelState.CLOSED,
        this.header,
        this.footer})
...
class _CustomSlidingUpPanelState extends State<CustomSlidingUpPanel>
  ...
  void initState() {
    ...
    _ac = new AnimationController(
        ...
        value: widget.defaultPanelState == CustomPanelState.CLOSED
            ? 0.0
  ...
  Widget build(BuildContext context) {
    return Stack(
      alignment: widget.slideDirection == CustomSlideDirection.UP
      ...
      children: <Widget>[
        ...
        !widget.backdropEnabled
          ...
          onVerticalDragEnd: widget.backdropTapClosesPanel
            ...
            if ((widget.slideDirection == CustomSlideDirection.UP
                ? 1
                : -1) *
          ...
          child: AnimatedBuilder(
            ...
            child: Stack(
              children: <Widget>[
                //open panel
                Positioned(
                    top: widget.slideDirection == CustomSlideDirection.UP
                        ? 0.0
                        : null,
                    bottom: widget.slideDirection == CustomSlideDirection.DOWN
                        ? 0.0
                        : null,
                    width: widget.width -
                        (widget.margin != null
                ...
                widget.header != null
                  ...
                  top: widget.slideDirection == CustomSlideDirection.UP
                      ...
                      : null,
                  bottom:
                  widget.slideDirection == CustomSlideDirection.DOWN
                      ? 0.0
                      : null,
  ...
  void _onGestureEnd(Velocity v) {
    ...
    if (widget.slideDirection == CustomSlideDirection.DOWN)
