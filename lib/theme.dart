...
final ThemeData appTheme = ThemeData.light().copyWith(
    ...
    textTheme: GoogleFonts.dmSansTextTheme().copyWith(
      headline5: TextStyle(fontSize: 22.0, color: ColorConstants.textDarkPrimary),
      headline6: TextStyle(fontSize: 18.0, color: ColorConstants.textDarkPrimary),
      subtitle1: TextStyle(color: ColorConstants.textDarkPrimary), //disabledTextColor),
      subtitle2: TextStyle(color: ColorConstants.textDarkSecondary),
      bodyText1: TextStyle(fontSize: 16.0, color: ColorConstants.textDarkPrimary),
      bodyText2: TextStyle(color: ColorConstants.textDarkSecondary),
      caption: TextStyle(color: ColorConstants.textDarkPrimary), //disabledTextColor),
      button: TextStyle(fontSize: 16.0, letterSpacing: 1, color: ColorConstants.white),
    ),
    primaryTextTheme: GoogleFonts.dmSansTextTheme().copyWith(
      headline5: TextStyle(fontSize: 22.0, color: ColorConstants.textLightPrimary, fontWeight: FontWeight.w800),
      headline6: TextStyle(fontSize: 18.0, color: ColorConstants.textLightPrimary, fontWeight: FontWeight.w800),
      subtitle1: TextStyle(fontSize: 16.0, color: ColorConstants.textLightPrimary),
      subtitle2: TextStyle(fontSize: 14.0, color: ColorConstants.textLightSecondary),
      bodyText1: TextStyle(fontSize: 16.0, color: ColorConstants.textLightPrimary),
      bodyText2: TextStyle(fontSize: 14.0, color: ColorConstants.textLightSecondary),
      caption: TextStyle(fontSize: 14.0, color: ColorConstants.textDarkPrimary),
      button: TextStyle(fontSize: 16.0, letterSpacing: 1, color: ColorConstants.disabledTextColor),
    ),
...
final ThemeData darkTheme = ThemeData.dark().copyWith(
  ...
  ///text theme
  textTheme: GoogleFonts.dmSansTextTheme().copyWith(
    headline5: TextStyle(fontSize: 22.0, color: ColorConstants.textLightPrimary),
    headline6: TextStyle(fontSize: 18.0, color: ColorConstants.textLightPrimary),
    subtitle1: TextStyle(color: ColorConstants.textLightPrimary),
    subtitle2: TextStyle(color: ColorConstants.textLightSecondary),
    bodyText1: TextStyle(fontSize: 16.0, color: ColorConstants.textLightPrimary),
    bodyText2: TextStyle(color: ColorConstants.textLightSecondary),
    caption: TextStyle(color: ColorConstants.textLightPrimary),
    button: TextStyle(fontSize: 16.0, letterSpacing: 1, color: ColorConstants.white),
  ),
